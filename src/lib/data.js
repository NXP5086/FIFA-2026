...
export const USERS = [
  ...
  { id: "u15", name: "Amrit",      initials: "AT", color: "#22C55E" },
  ...
  { id: "u19", name: "Vijit",      initials: "VK", color: "#64748B" },
  ...
  { id: "u46", name: "Gai",        initials: "GT", color: "#A16207" },
  { id: "u47", name: "Aien",       initials: "AC", color: "#4F46E5" },
  { id: "u48", name: "Benrio",     initials: "BH", color: "#831843" },
  { id: "u49", name: "Chuba",      initials: "CG", color: "#9D174D" },
  { id: "u50", name: "Nzamo",      initials: "NZ", color: "#064E3B" },
...
export const LOCK_WINDOWS = (function () {
  const md1First   = firstKickoff(m => m.stage === "GROUP" && m.matchday === 1);
  ...
  return {
    MD1:    md1First   ? md1First   - TWO_HOURS_MS : null,
